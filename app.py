...
def load_semantic_model():
    ...
    model = AutoModelForSemanticSegmentation.from_pretrained("nvidia/segformer-b1-finetuned-cityscapes-1024-1024")
...
def load_instance_model():
    ...
    model = AutoModelForInstanceSegmentation.from_pretrained("facebook/mask2former-swin-base-coco-instance")
    return processor, model
